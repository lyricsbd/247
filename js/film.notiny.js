(function($) {
  ...
  defaults = {
    ...
    theme: 'dark',
    template: '<div class="k-animation-container notiny-base"><div class="notification info"><span id="alert-icon" class="icons"></span><span class="left"><h2 class="notiny-title"></h2><p class="notiny-text"></p></span><div class="clear"></div></div></div>',
    width: '300',
    text: '',
    icon: '',
    background: true,
